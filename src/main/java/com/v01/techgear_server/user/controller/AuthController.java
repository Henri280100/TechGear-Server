...
public class AuthController {
    ...
    public AuthController(@Lazy TokenGenerator tokenGenerator, UserDetailsManager userDetailsManager, UserRepository userRepository, EmailService emailService, AuthServiceImpl userDetailsServiceImpl, DaoAuthenticationProvider daoAuthenticationProvider, TokenService customTokenService) {
